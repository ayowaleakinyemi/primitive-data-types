...
let number1IsNumber = Number.isFinite(isNumber1)
let number2IsNumber = Number.isFinite(isNumber2)
...
let percentage = (scoreValue / maxValue) * 100
let scorePercentage = percentage.toFixed(2)
...
let match = parseTheNumber.match(/[\d.]+/);
let parsedNumber = parseFloat(match[0]);
