...
LowerMS = mainString.lower()
LowerSS = subString.lower()
stringContains = LowerSS in LowerMS
...
CaseCheck1 = checkEqualityIgnoreCase1.lower()
CaseCheck2 = checkEqualityIgnoreCase2.lower()
stringsAreEqualIgnoreCase = CaseCheck1 == CaseCheck2
